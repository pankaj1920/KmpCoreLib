...
public object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/syncride.core.resources.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/syncride.core.resources.generated.resources/" + path)
